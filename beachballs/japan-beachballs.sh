...
gmt begin
	...
	gmt figure japan-beachballs-mapview
	...
	gmt grdimage @earth_relief_02m -Cglobe -I+d
	...
	gmt meca japan-focal.dat -Sd0.5c -Z -i0-11
	...
	gmt figure japan-beachballs-sideview
	...
	# Use -i0-11 to skip the trailing "event title" in the 13rd column (column number starts at 0).
	gmt coupe japan-focal.dat -Sd0.5c -Aa126/42/146/40/90/500/0/700+f -Q -Z -i0-11 \
		-JX15c/-10c -R0/2000/0/700 -BWSen -Bxaf+l"Distance (km)" -Byaf+l"Depth (km)"
	# Add the colorbar to the Bottom Right (BR) and shift to the right by 2 cm.
