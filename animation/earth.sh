...
# 2. Run the movie and build a MP4 animation, with elapsed time
# gmt movie earth.sh -C360p -T91 -Fmp4 -Nearth -Lf
# 3. Run the movie and build a MP4 animation at 720p, with 360 degrees and progress indicator
# gmt movie earth.sh -C720p -T360 -Fmp4 -Nearth -Pa -Lf -Z
# 4. Run the movie and build a GIF animation, with A progress indicator
